...
2. **数据库门禁**：新库按 V1 → V2 → [V3__academic_insights.sql](../vcampus-server/src/main/resources/db/migration/V3__academic_insights.sql) → [V4__store_experience.sql](../vcampus-server/src/main/resources/db/migration/V4__store_experience.sql) → V5 → [V6__ai_assistant_knowledge.sql](../vcampus-server/src/main/resources/db/migration/V6__ai_assistant_knowledge.sql) → [V7__ai_knowledge_and_tools.sql](../vcampus-server/src/main/resources/db/migration/V7__ai_knowledge_and_tools.sql) → [V8__ai_quality_workbench.sql](../vcampus-server/src/main/resources/db/migration/V8__ai_quality_workbench.sql) 执行；检查结果以 [DB_COMPATIBILITY_REPORT.md](DB_COMPATIBILITY_REPORT.md) 为准。
