...
| 公寓管理、违纪处分、系统操作和代办指南知识 | [x] | V6__ai_assistant_knowledge.sql、V7__ai_knowledge_and_tools.sql、KnowledgeRanker |
| 学生失败重试、附件管理、回答反馈和会话搜索/重命名/归档/导出 | [x] | AiChatPanel、AiFeedbackService、AiFeedbackRepository、V8__ai_quality_workbench.sql |
