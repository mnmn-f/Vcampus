...
本文专门说明 VCampus AI 助手模块的设计目标、现有功能、系统边界、运行方式和扩展方法。模块实现参考[软件设计说明书](../软件设计说明书.docx)，并以当前项目代码为准。
...
当前合并基线为 253 个测试，0 失败、0 错误；默认跳过 10 个需要真实 MySQL 配置的集成测试。详细手工步骤见 [TEST_MANUAL.md](TEST_MANUAL.md)。
