...
public final class AiToolService {
    ...
    public Map<String, AiToolMetric> metrics() {
        return tx(new Work<Map<String, AiToolMetric>>() {
            public Map<String, AiToolMetric> run(Connection c) throws Exception {
                return repository.metrics(c);
            }
        });
    }
