...
public final class AiCommandRegistry {
    ...
    public static CommandRouter registerAll(CommandRouter router, TransactionManager transactions) {
        ...
        register(router, AiCommands.SESSION_ARCHIVED, Permission.AI_QUERY, assistant, conversations, knowledge, feedback);
        ...
        register(router, AiCommands.SESSION_RESTORE, Permission.AI_QUERY, assistant, conversations, knowledge, feedback);
        ...
        register(router, AiCommands.KNOWLEDGE_IMPORT, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge, feedback);
        ...
        register(router, AiCommands.FEEDBACK_UPDATE, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge, feedback);
        register(router, AiCommands.TOOL_ROUTE_TEST, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge, feedback);
