...
public final class AiCommandRegistry {
    ...
    public static CommandRouter registerAll(CommandRouter router, TransactionManager transactions) {
        ...
        register(router, AiCommands.CANCEL, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.CONFIRM, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.SESSION_LIST, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.SESSION_CREATE, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.SESSION_HISTORY, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.SESSION_CLEAR, Permission.AI_QUERY, assistant, conversations, knowledge);
        register(router, AiCommands.KNOWLEDGE_LIST, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge);
        register(router, AiCommands.KNOWLEDGE_SAVE, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge);
        register(router, AiCommands.KNOWLEDGE_DELETE, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge);
        register(router, AiCommands.MONITOR, Permission.AI_KNOWLEDGE_MANAGE, assistant, conversations, knowledge);
        return router;
    }
    ...
    private static void register(CommandRouter router, String command, Permission permission,
        ...
        router.register(command, new AiCommandHandler(command, permission,
                assistant, conversations, knowledge));
    }
}
