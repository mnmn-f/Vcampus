...
final class LibraryRoomBookingPanel extends JPanel {
    ...
    private void showSummary() {
        summary.removeAll(); if (selected == null) summary.add(LibraryUi.state("请从左侧选择自习室", null)); else {
            ...
            JButton confirm = LibraryUi.button("确认预约", true, () -> { }); clearActions(confirm); confirm.addActionListener(e -> reserve(confirm)); summary.add(confirm);
        }
