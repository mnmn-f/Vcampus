...
public interface AiAssistantClientService {
    ...
    default String queryWithRequestId(String requestId, String sessionId, String text, AiMode mode,
            List<AiAttachment> attachments, AiStreamListener listener) {
        return query(sessionId, text, mode, attachments, listener);
    }
    ...
    default List<AiSessionSummary> archivedSessions() throws ClientServiceException {
        throw unsupported();
    }
    default void restoreSession(String sessionId) throws ClientServiceException { throw unsupported(); }
    ...
    default AiKnowledgeImportResult importKnowledge(AiKnowledgeBatchRequest request)
    ...
    default List<AiFeedbackEntry> feedback() throws ClientServiceException {
        return feedback(new AiFeedbackQuery(null, null, null, null, null));
    }
    default List<AiFeedbackEntry> feedback(AiFeedbackQuery query)
            throws ClientServiceException { throw unsupported(); }
    default void updateFeedback(AiFeedbackTriageRequest request)
            throws ClientServiceException { throw unsupported(); }
    default List<AiToolStatus> toolStatuses() throws ClientServiceException { throw unsupported(); }
    default AiToolRouteTestResult testToolRoute(String question)
            throws ClientServiceException { throw unsupported(); }
